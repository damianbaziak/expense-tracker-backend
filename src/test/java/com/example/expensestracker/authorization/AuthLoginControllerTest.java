...
import com.example.expensestracker.authorization.api.dto.AuthAccessTokenDTO;
...
class AuthLoginControllerTest {
    ...
    void authenticateUser_invalidPasswordPattern_returnsBadRequestAndErrorMessage(
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.descriptionList[0]").value(Matchers.containsString(expectedMessage)));
